void my_fused_impl(const Weights<float> filter, const Weights<float> input, float* bias, Weights<float> output, int64_t maxpool_dim83, int64_t x_tile86, int64_t y_tile87, int64_t stride_arg74){
  int64_t x84 = 0;
 int64_t y85 = 0;
 int64_t x82 = maxpool_dim83*x84;
 int64_t y81 = y85*maxpool_dim83;
 int64_t x_tile79 = maxpool_dim83*x_tile86;
 int64_t y_tile80 = maxpool_dim83*y_tile87;
 int64_t x75 = x82;
 int64_t y76 = y81;
 int64_t x_tile77 = x_tile79;
 int64_t y_tile78 = y_tile80;
 Weights<float> output_conv_q = weight_alloc(x75, y76, x_tile77, y_tile78);
 Weights<float> output_relu_q = weight_alloc(x82, y81, x_tile79, y_tile80);
