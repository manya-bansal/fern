...
int64_t x_tile18 = maxpool_dim21 * x_tile22;
int64_t y_tile17 = maxpool_dim21 * y_tile25;
int64_t x13 = x20;
int64_t y14 = y19;
int64_t x_tile15 = x_tile18;
int64_t y_tile16 = y_tile17;
Weights<float> output_conv_q = weight_alloc(x13, y14, x_tile15, y_tile16);
Weights<float> output_relu_q = weight_alloc(x20, y19, x_tile18, y_tile17);
