void my_fused_impl(const Weights<float> filter, const Weights<float> input, float* bias, Weights<float> output_tan, int64_t stride_arg80, int64_t maxpool_dim89, int64_t y_tile95, int64_t x_tile96){
  int64_t x94 = 0;
 int64_t y97 = 0;
 int64_t x91 = x94;
 int64_t y92 = y97;
 ...
 int64_t x88 = x91*maxpool_dim89;
 int64_t y87 = y92*maxpool_dim89;
 int64_t x_tile85 = maxpool_dim89*x_tile90;
 int64_t y_tile86 = y_tile93*maxpool_dim89;
 int64_t x81 = x88;
 int64_t y82 = y87;
