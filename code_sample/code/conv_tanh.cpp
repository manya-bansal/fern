void my_fused_impl(const Weights<float> filter, const Weights<float> input, float* bias, Weights<float> output_tan, int64_t x_tile158, int64_t y_tile159, int64_t stride_arg142, int64_t maxpool_dim151){
  int64_t x156 = 0;
 int64_t y157 = 0;
 int64_t x152 = x156;
 int64_t y153 = y157;
 int64_t x_tile154 = x_tile158;
 int64_t y_tile155 = y_tile159;
 int64_t x149 = maxpool_dim151*x152;
 int64_t y148 = y153*maxpool_dim151;
 int64_t x_tile150 = maxpool_dim151*x_tile154;
 int64_t y_tile147 = y_tile155*maxpool_dim151;
 int64_t x143 = x149;
 int64_t y144 = y148;
 int64_t x_tile145 = x_tile150;
 int64_t y_tile146 = y_tile147;
 Weights<float> output_conv_q = weight_alloc(x143, y144, x_tile145, y_tile146);
 Weights<float> output_relu_q = weight_alloc(x149, y148, x_tile150, y_tile147);
 Weights<float> output_q = weight_alloc(x152, y153, x_tile154, y_tile155);
