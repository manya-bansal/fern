void my_fused_impl(const image<float> input, image<float> out2, int64_t o_s, int64_t x_tile72, int64_t y_tile73, int64_t y_tile67){
 for(int64_t y68 = 0;y68 < out2.logical_cols; y68+=y_tile67){
  cilk_scope {
   cilk_for(int64_t o = 0;o < out2.logical_rows; o+=o_s){
    ...
    int64_t x62 = x69;
    int64_t y63 = y68;
    int64_t x_tile64 = 2+x_tile66;
    int64_t y_tile65 = y_tile67;
    ...
    for(int64_t i = o;i < o_s; i+=1){
     ...
     int64_t x_tile64 = 2+x_tile66;
     int64_t y_tile65 = y_tile67;
     image<float> out2_q = out2.get_tile(x69, y68, x_tile66, y_tile67);
