void my_fused_impl(const image<float> input, image<float> out2, int64_t x_tile72, int64_t y_tile73, int64_t o_s, int64_t y_tile66){
 for(int64_t y67 = 0;y67 < out2.logical_cols; y67+=y_tile66){
  cilk_scope {
   cilk_for(int64_t o = 0;o < out2.logical_rows; o+=o_s){
    ...
    int64_t x62 = x68;
    int64_t y63 = y67;
    int64_t x_tile64 = 2+x_tile69;
    int64_t y_tile65 = y_tile66;
    ...
    for(int64_t i = o;i < o_s; i+=1){
     ...
     int64_t x_tile64 = 2+x_tile69;
     int64_t y_tile65 = y_tile66;
     image<float> out2_q = out2.get_tile(x68, y67, x_tile69, y_tile66);
