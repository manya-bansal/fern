 ...
 for(int64_t y129 = 0;y129 < final_out.logical_cols; y129+=y_tile131){
  cilk_scope {
   cilk_for(int64_t o = 0;o < final_out.logical_rows; o+=o_s){
    ...
    int64_t x117 = x123;
    int64_t y118 = y122;
    int64_t x_tile119 = x_tile120;
    int64_t y_tile116 = y_tile121;
    int64_t x113 = x117;
    int64_t y114 = y118;
    int64_t x_tile115 = x_tile119;
    int64_t y_tile112 = 6+y_tile116;
    image<float> gray_out_q = alloc_image(x108, y109, x_tile110, y_tile111);
    image<float> blur_y_temp_q = alloc_image(x113, y114, x_tile115, y_tile112);
    image<float> blur_x_temp_q = alloc_image(x117, y118, x_tile119, y_tile116);
    image<float> sharpen_temp_q = alloc_image(x123, y122, x_tile120, y_tile121);
