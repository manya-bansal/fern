void my_fused_impl(const Array<float> lat2, const Array<float> lon2, Array<float> a){
 ...
 for(int64_t x243 = a.idx;x243 < a.idx + a.size; x243+=len242){
  ...
  Array<float> a_q = a.array_query_no_materialize(x243, len242);
    ispc::subi_ispc(lat2_q48.data, 0.709843, len210, dlon_q.data);
    ispc::subi_ispc(lon2_q47.data, -1.23892, len212, dlat_q.data);
    ispc::divi_ispc(dlon_q.data, 2, len214, dlon_q.data);
    ...
    ispc::muli_ispc(dlon_q.data, 0.758464, len224, dlon_q.data);
    ispc::divi_ispc(dlat_q.data, 2, len226, dlat7_q.data);
    ...
    ispc::muli_ispc(a5_q.data, 2, len240, a6_q.data);
    ispc::muli_ispc(a6_q.data, 3959, len242, a_q.data);
}
