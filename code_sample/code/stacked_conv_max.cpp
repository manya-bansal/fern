...
int64_t x_tile29 = maxpool_dim31*x_tile32;
int64_t y_tile30 = maxpool_dim31*y_tile35;
Weights<float> input_q_8 = input.query_materialize(x27 * stride_arg26, y28 * stride_arg26, x_tile29 + x_tile29 - 1, y_tile30 + y_tile30 - 1);
Weights<float> output_t_q = output_t.query_materialize(x44, y43, x_tile42, y_tile45);
conv_new_mkl(input_q_8, filter0, bias, stride_arg26, output_conv1_q);
maxpool(output_conv1_q_, maxpool_dim31, output_max1_q);
conv_new_mkl(output_max1_q_, filter0, bias, stride_arg36, output_conv2_q);
maxpool(output_conv2_q_, maxpool_dim41, output_t_q);
output_t.insert_materialize(x44, y43, x_tile42, y_tile45, output_t_q);
input_q_8.free_weight();
