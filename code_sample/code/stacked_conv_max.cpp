void my_fused_impl(const Weights<float> filter0, const Weights<float> input, float* bias, Weights<float> output_t, int64_t stride_arg88, int64_t maxpool_dim93, int64_t stride_arg98, int64_t maxpool_dim103, int64_t x_tile106, int64_t y_tile107){
  int64_t x104 = 0;
 int64_t y105 = 0;
 int64_t x99 = x104*maxpool_dim103;
 int64_t y101 = y105*maxpool_dim103;
 int64_t x_tile102 = maxpool_dim103*x_tile106;
 int64_t y_tile100 = y_tile107*maxpool_dim103;
 int64_t x96 = stride_arg98*x99;
 int64_t y94 = stride_arg98*y101;
 int64_t x_tile95 = -1+x_tile102+filter0.H;
 int64_t y_tile97 = -1+y_tile100+filter0.W;
 int64_t x89 = maxpool_dim93*x96;
 int64_t y90 = y94*maxpool_dim93;
 int64_t x_tile91 = maxpool_dim93*x_tile95;
 int64_t y_tile92 = y_tile97*maxpool_dim93;
 Weights<float> output_conv1_q = weight_alloc(x89, y90, x_tile91, y_tile92);
 Weights<float> output_max1_q = weight_alloc(x96, y94, x_tile95, y_tile97);
 Weights<float> output_conv2_q = weight_alloc(x99, y101, x_tile102, y_tile100);
