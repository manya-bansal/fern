            ...
            for node in gm.graph.nodes:
                ...
                if node.target in torch_to_fern:
                    ...
                    for arg in node.args:
                        arg_idx = dummy_var_idx[arg.name]
                        evaled_args.append(args[arg_idx])
                    dummy_val = node.target(*evaled_args)

                    input_vals[node.name] = dummy_val
